      ...
      <v-col cols="12">
        ...
        >
          ...
          <template #item.actions="{ item }">
            <distributor-item-dialog :resource="item['@id']" mode="edit" @updated="loadItems" />
            <distributor-item-dialog :resource="item['@id']" mode="show" />
          </template>
        </v-data-table>
      </v-col>
    </v-row>
    <distributor-item-dialog :is-new="true" resource="/delivery/distributors" mode="edit" @updated="loadItems" />
  </v-container>
</template>
